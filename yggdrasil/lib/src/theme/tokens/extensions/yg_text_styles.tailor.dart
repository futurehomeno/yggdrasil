...
class YgTextStyle extends ThemeExtension<YgTextStyle> {
  ...
  YgTextStyle lerp(covariant ThemeExtension<YgTextStyle>? other, double t) {
    ...
    return YgTextStyle(
      ...
      caption1Regular: TextStyle.lerp(
        caption1Regular,
        other.caption1Regular,
        t,
      )!,
      ...
      display1Regular: TextStyle.lerp(
        display1Regular,
        other.display1Regular,
        t,
      )!,
      ...
      display2Regular: TextStyle.lerp(
        display2Regular,
        other.display2Regular,
        t,
      )!,
      ...
      display3Regular: TextStyle.lerp(
        display3Regular,
        other.display3Regular,
        t,
      )!,
      pageHeading1Bold: TextStyle.lerp(
        pageHeading1Bold,
        other.pageHeading1Bold,
        t,
      )!,
      pageHeading1Medium: TextStyle.lerp(
        pageHeading1Medium,
        other.pageHeading1Medium,
        t,
      )!,
      pageHeading1Regular: TextStyle.lerp(
        pageHeading1Regular,
        other.pageHeading1Regular,
        t,
      )!,
      pageHeading2Bold: TextStyle.lerp(
        pageHeading2Bold,
        other.pageHeading2Bold,
        t,
      )!,
      pageHeading2Medium: TextStyle.lerp(
        pageHeading2Medium,
        other.pageHeading2Medium,
        t,
      )!,
      pageHeading2Regular: TextStyle.lerp(
        pageHeading2Regular,
        other.pageHeading2Regular,
        t,
      )!,
      pageHeading3Bold: TextStyle.lerp(
        pageHeading3Bold,
        other.pageHeading3Bold,
        t,
      )!,
      pageHeading3Medium: TextStyle.lerp(
        pageHeading3Medium,
        other.pageHeading3Medium,
        t,
      )!,
      pageHeading3Regular: TextStyle.lerp(
        pageHeading3Regular,
        other.pageHeading3Regular,
        t,
      )!,
      paragraph1Bold: TextStyle.lerp(paragraph1Bold, other.paragraph1Bold, t)!,
      paragraph1Medium: TextStyle.lerp(
        paragraph1Medium,
        other.paragraph1Medium,
        t,
      )!,
      paragraph1Regular: TextStyle.lerp(
        paragraph1Regular,
        other.paragraph1Regular,
        t,
      )!,
      paragraph2Bold: TextStyle.lerp(paragraph2Bold, other.paragraph2Bold, t)!,
      paragraph2Medium: TextStyle.lerp(
        paragraph2Medium,
        other.paragraph2Medium,
        t,
      )!,
      paragraph2Regular: TextStyle.lerp(
        paragraph2Regular,
        other.paragraph2Regular,
        t,
      )!,
      paragraph3Bold: TextStyle.lerp(paragraph3Bold, other.paragraph3Bold, t)!,
      paragraph3Medium: TextStyle.lerp(
        paragraph3Medium,
        other.paragraph3Medium,
        t,
      )!,
      paragraph3Regular: TextStyle.lerp(
        paragraph3Regular,
        other.paragraph3Regular,
        t,
      )!,
      sectionHeading1Bold: TextStyle.lerp(
        sectionHeading1Bold,
        other.sectionHeading1Bold,
        t,
      )!,
      sectionHeading1Medium: TextStyle.lerp(
        sectionHeading1Medium,
        other.sectionHeading1Medium,
        t,
      )!,
      sectionHeading1Regular: TextStyle.lerp(
        sectionHeading1Regular,
        other.sectionHeading1Regular,
        t,
      )!,
      sectionHeading2Bold: TextStyle.lerp(
        sectionHeading2Bold,
        other.sectionHeading2Bold,
        t,
      )!,
      sectionHeading2Medium: TextStyle.lerp(
        sectionHeading2Medium,
        other.sectionHeading2Medium,
        t,
      )!,
      sectionHeading2Regular: TextStyle.lerp(
        sectionHeading2Regular,
        other.sectionHeading2Regular,
        t,
      )!,
      sectionHeading3Bold: TextStyle.lerp(
        sectionHeading3Bold,
        other.sectionHeading3Bold,
        t,
      )!,
      sectionHeading3Medium: TextStyle.lerp(
        sectionHeading3Medium,
        other.sectionHeading3Medium,
        t,
      )!,
      sectionHeading3Regular: TextStyle.lerp(
        sectionHeading3Regular,
        other.sectionHeading3Regular,
        t,
      )!,
    );
  }
