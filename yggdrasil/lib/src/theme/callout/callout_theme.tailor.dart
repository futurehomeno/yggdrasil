...
class YgCalloutTheme extends ThemeExtension<YgCalloutTheme> {
  ...
  @override
  YgCalloutTheme lerp(
    covariant ThemeExtension<YgCalloutTheme>? other,
    double t,
  ) {
    ...
    return YgCalloutTheme(
      ...
      closeButtonSpacing: t < 0.5
          ? closeButtonSpacing
          : other.closeButtonSpacing,
      criticalCalloutTheme: criticalCalloutTheme.lerp(
        other.criticalCalloutTheme,
        t,
      ) as CriticalCalloutTheme,
