...
class SegmentedBarTween extends Tween<SegmentedBar> {
  SegmentedBarTween({
    ...
    // TODO: Add some stuff to handle null values.
    ...
    final List<DataVariant> lcs = beginVariants.longestCommonSublist(endVariants);
    ...
    for (final DataVariant variant in lcs) {
