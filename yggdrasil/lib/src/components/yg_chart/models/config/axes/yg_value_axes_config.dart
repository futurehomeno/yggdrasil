...
import 'package:yggdrasil/src/components/yg_chart/models/config/axes/yg_single_axis_config.dart';
import 'package:yggdrasil/src/components/yg_chart/models/formatters/yg_simple_value_formatter.dart';

class YgValueAxesConfig extends YgSingleAxisConfig {
  const YgValueAxesConfig({
    super.metric,
    super.range,
    super.widget,
