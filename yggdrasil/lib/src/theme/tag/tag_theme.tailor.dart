...
class YgTagTheme extends ThemeExtension<YgTagTheme> {
  ...
  YgTagTheme lerp(covariant ThemeExtension<YgTagTheme>? other, double t) {
    ...
    return YgTagTheme(
      ...
      informativeTagTheme: informativeTagTheme.lerp(other.informativeTagTheme, t) as YgInformativeTagTheme,
      negativeTagTheme: negativeTagTheme.lerp(other.negativeTagTheme, t) as YgNegativeTagTheme,
      neutralTagTheme: neutralTagTheme.lerp(other.neutralTagTheme, t) as YgNeutralTagTheme,
      paddingMedium: t < 0.5 ? paddingMedium : other.paddingMedium,
      paddingSmall: t < 0.5 ? paddingSmall : other.paddingSmall,
      positiveTagTheme: positiveTagTheme.lerp(other.positiveTagTheme, t) as YgPositiveTagTheme,
      splashStrongColor: Color.lerp(splashStrongColor, other.splashStrongColor, t)!,
      ...
      warningTagTheme: warningTagTheme.lerp(other.warningTagTheme, t) as YgWarningTagTheme,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(splashStrongColor, other.splashStrongColor) &&
            const DeepCollectionEquality().equals(splashWeakColor, other.splashWeakColor) &&
