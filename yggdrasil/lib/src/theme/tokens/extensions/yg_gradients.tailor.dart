...
class YgGradient extends ThemeExtension<YgGradient> {
  ...
  YgGradient lerp(covariant ThemeExtension<YgGradient>? other, double t) {
    ...
    return YgGradient(
      actionPrimaryDefault: t < 0.5
          ? actionPrimaryDefault
          : other.actionPrimaryDefault,
      actionPrimaryHovered: t < 0.5
          ? actionPrimaryHovered
          : other.actionPrimaryHovered,
      actionPrimaryPressed: t < 0.5
          ? actionPrimaryPressed
          : other.actionPrimaryPressed,
      actionPrimarySelected: t < 0.5
          ? actionPrimarySelected
          : other.actionPrimarySelected,
      actionSecondaryDefault: t < 0.5
          ? actionSecondaryDefault
          : other.actionSecondaryDefault,
      actionSecondaryHovered: t < 0.5
          ? actionSecondaryHovered
          : other.actionSecondaryHovered,
      actionSecondaryPressed: t < 0.5
          ? actionSecondaryPressed
          : other.actionSecondaryPressed,
      actionSecondarySelected: t < 0.5
          ? actionSecondarySelected
          : other.actionSecondarySelected,
