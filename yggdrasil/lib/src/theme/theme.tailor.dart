...
class YgTheme extends ThemeExtension<YgTheme> {
  ...
  YgTheme lerp(covariant ThemeExtension<YgTheme>? other, double t) {
    ...
    return YgTheme(
      ...
      bottomNavigationBarTheme: bottomNavigationBarTheme.lerp(
        other.bottomNavigationBarTheme,
        t,
      ) as YgBottomNavigationBarTheme,
      bottomSheetTheme: bottomSheetTheme.lerp(
        other.bottomSheetTheme,
        t,
      ) as YgBottomSheetTheme,
      buttonGroupTheme: buttonGroupTheme.lerp(
        other.buttonGroupTheme,
        t,
      ...
      miniBarGraphTheme: miniBarGraphTheme.lerp(
        other.miniBarGraphTheme,
        t,
      ) as YgMiniBarGraphTheme,
      mobileScannerContainerTheme: mobileScannerContainerTheme.lerp(
      ...
      searchFieldTheme: searchFieldTheme.lerp(
        other.searchFieldTheme,
        t,
      ) as YgSearchFieldTheme,
      searchModalTheme: searchModalTheme.lerp(
        other.searchModalTheme,
        t,
      ...
      stepperButtonTheme: stepperButtonTheme.lerp(
        other.stepperButtonTheme,
        t,
      ...
      toggleButtonTheme: toggleButtonTheme.lerp(
        other.toggleButtonTheme,
        t,
      ) as YgToggleButtonTheme,
      tokens: tokens.lerp(other.tokens, t) as YgTokens,
      wizardHeaderTheme: wizardHeaderTheme.lerp(
        other.wizardHeaderTheme,
        t,
...
extension YgThemeBuildContextProps on BuildContext {
  ...
  YgBottomNavigationBarTheme get bottomNavigationBarTheme =>
      ygTheme.bottomNavigationBarTheme;
