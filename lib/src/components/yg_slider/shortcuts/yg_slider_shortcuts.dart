...
class YgSliderShortcuts {
  ...
  static const Map<ShortcutActivator, Intent> _directionalNavShortcutMap = <ShortcutActivator, Intent>{
    SingleActivator(LogicalKeyboardKey.arrowLeft): YgSliderAdjustmentDecreaseIntent(),
    SingleActivator(LogicalKeyboardKey.arrowRight): YgSliderAdjustmentIncreaseIntent(),
  };

  // Keyboard mapping for a focused slider.
  static const Map<ShortcutActivator, Intent> _traditionalNavShortcutMap = <ShortcutActivator, Intent>{
    SingleActivator(LogicalKeyboardKey.arrowUp): YgSliderAdjustmentIncreaseIntent(),
    SingleActivator(LogicalKeyboardKey.arrowDown): YgSliderAdjustmentDecreaseIntent(),
