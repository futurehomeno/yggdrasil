...
class ToggleIconTextButtonTheme
    extends ThemeExtension<ToggleIconTextButtonTheme> {
  ...
  static final ToggleIconTextButtonTheme consumerLight =
  ...
  static final ToggleIconTextButtonTheme consumerDark =
      ToggleIconTextButtonTheme(
  ...
  static final ToggleIconTextButtonTheme professionalLight =
      ToggleIconTextButtonTheme(
  ...
  static final ToggleIconTextButtonTheme professionalDark =
      ToggleIconTextButtonTheme(
  ...
  @override
  ToggleIconTextButtonTheme lerp(
      covariant ThemeExtension<ToggleIconTextButtonTheme>? other, double t) {
    if (other is! ToggleIconTextButtonTheme)
      return this as ToggleIconTextButtonTheme;
    return ToggleIconTextButtonTheme(
