...
class ProgressPercentageIndicatorTheme
    extends ThemeExtension<ProgressPercentageIndicatorTheme> {
  ...
  static final ProgressPercentageIndicatorTheme
  consumerLight = ProgressPercentageIndicatorTheme(
    contentSpacing: _$ProgressPercentageIndicatorTheme.contentSpacing[0],
    percentageTextStyle:
        _$ProgressPercentageIndicatorTheme.percentageTextStyle[0],
    progressBarHeight: _$ProgressPercentageIndicatorTheme.progressBarHeight[0],
    remainingSubtitleTextStyle:
        _$ProgressPercentageIndicatorTheme.remainingSubtitleTextStyle[0],
    ...
    timeRemainingTextStyle:
        _$ProgressPercentageIndicatorTheme.timeRemainingTextStyle[0],
    titleTextStyle: _$ProgressPercentageIndicatorTheme.titleTextStyle[0],
  );

  static final ProgressPercentageIndicatorTheme
  consumerDark = ProgressPercentageIndicatorTheme(
    contentSpacing: _$ProgressPercentageIndicatorTheme.contentSpacing[1],
    percentageTextStyle:
        _$ProgressPercentageIndicatorTheme.percentageTextStyle[1],
    progressBarHeight: _$ProgressPercentageIndicatorTheme.progressBarHeight[1],
    remainingSubtitleTextStyle:
        _$ProgressPercentageIndicatorTheme.remainingSubtitleTextStyle[1],
    ...
    timeRemainingTextStyle:
        _$ProgressPercentageIndicatorTheme.timeRemainingTextStyle[1],
    titleTextStyle: _$ProgressPercentageIndicatorTheme.titleTextStyle[1],
  );

  static final ProgressPercentageIndicatorTheme
  professionalLight = ProgressPercentageIndicatorTheme(
    contentSpacing: _$ProgressPercentageIndicatorTheme.contentSpacing[2],
    percentageTextStyle:
        _$ProgressPercentageIndicatorTheme.percentageTextStyle[2],
    progressBarHeight: _$ProgressPercentageIndicatorTheme.progressBarHeight[2],
    remainingSubtitleTextStyle:
        _$ProgressPercentageIndicatorTheme.remainingSubtitleTextStyle[2],
    ...
    timeRemainingTextStyle:
        _$ProgressPercentageIndicatorTheme.timeRemainingTextStyle[2],
    titleTextStyle: _$ProgressPercentageIndicatorTheme.titleTextStyle[2],
  );

  static final ProgressPercentageIndicatorTheme
  professionalDark = ProgressPercentageIndicatorTheme(
    contentSpacing: _$ProgressPercentageIndicatorTheme.contentSpacing[3],
    percentageTextStyle:
        _$ProgressPercentageIndicatorTheme.percentageTextStyle[3],
    progressBarHeight: _$ProgressPercentageIndicatorTheme.progressBarHeight[3],
    remainingSubtitleTextStyle:
        _$ProgressPercentageIndicatorTheme.remainingSubtitleTextStyle[3],
    ...
    timeRemainingTextStyle:
        _$ProgressPercentageIndicatorTheme.timeRemainingTextStyle[3],
  ...
  ProgressPercentageIndicatorTheme copyWith({
    ...
    return ProgressPercentageIndicatorTheme(
      ...
      remainingSubtitleTextStyle:
          remainingSubtitleTextStyle ?? this.remainingSubtitleTextStyle,
      shimmerColor: shimmerColor ?? this.shimmerColor,
      subtitleTextStyle: subtitleTextStyle ?? this.subtitleTextStyle,
      timeRemainingTextStyle:
          timeRemainingTextStyle ?? this.timeRemainingTextStyle,
  ...
  ProgressPercentageIndicatorTheme lerp(
    covariant ThemeExtension<ProgressPercentageIndicatorTheme>? other,
    double t,
  ) {
    if (other is! ProgressPercentageIndicatorTheme)
      return this as ProgressPercentageIndicatorTheme;
    return ProgressPercentageIndicatorTheme(
      contentSpacing: t < 0.5 ? contentSpacing : other.contentSpacing,
      percentageTextStyle: TextStyle.lerp(
        percentageTextStyle,
        other.percentageTextStyle,
        t,
      )!,
      progressBarHeight: t < 0.5 ? progressBarHeight : other.progressBarHeight,
      remainingSubtitleTextStyle: TextStyle.lerp(
        remainingSubtitleTextStyle,
        other.remainingSubtitleTextStyle,
        t,
      )!,
      ...
      timeRemainingTextStyle: TextStyle.lerp(
        timeRemainingTextStyle,
        other.timeRemainingTextStyle,
        t,
      )!,
