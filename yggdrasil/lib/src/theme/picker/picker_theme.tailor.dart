...
class YgPickerTheme extends ThemeExtension<YgPickerTheme> {
  ...
  YgPickerTheme lerp(covariant ThemeExtension<YgPickerTheme>? other, double t) {
    ...
    return YgPickerTheme(
      ...
      indicatorBorderRadius: t < 0.5
          ? indicatorBorderRadius
          : other.indicatorBorderRadius,
      indicatorColor: Color.lerp(indicatorColor, other.indicatorColor, t)!,
      indicatorPadding: t < 0.5 ? indicatorPadding : other.indicatorPadding,
      minimumColumnWidth: t < 0.5
          ? minimumColumnWidth
          : other.minimumColumnWidth,
      textDefaultStyle: TextStyle.lerp(
        textDefaultStyle,
        other.textDefaultStyle,
        t,
      )!,
      textPadding: t < 0.5 ? textPadding : other.textPadding,
      textSelectedStyle: TextStyle.lerp(
        textSelectedStyle,
        other.textSelectedStyle,
        t,
      )!,
    );
  }
