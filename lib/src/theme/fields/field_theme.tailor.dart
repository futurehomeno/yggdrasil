...
class YgFieldTheme extends ThemeExtension<YgFieldTheme> {
  ...
  final YgDropdownFieldTheme dropdownTheme;
  ...
  static final YgFieldTheme consumerLight = YgFieldTheme(
    ...
    dropdownTheme: _$YgFieldTheme.dropdownTheme[0],
  );
  ...
  static final YgFieldTheme consumerDark = YgFieldTheme(
    ...
    dropdownTheme: _$YgFieldTheme.dropdownTheme[1],
  );
  ...
  static final YgFieldTheme professionalLight = YgFieldTheme(
    ...
    dropdownTheme: _$YgFieldTheme.dropdownTheme[2],
  );
  ...
  static final YgFieldTheme professionalDark = YgFieldTheme(
    ...
    dropdownTheme: _$YgFieldTheme.dropdownTheme[3],
  );
  ...
  YgFieldTheme copyWith({
    ...
    YgDropdownFieldTheme? dropdownTheme,
  }) {
    return YgFieldTheme(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(dropdownTheme, other.dropdownTheme));
  }
  ...
  int get hashCode {
    return Object.hash(
      ...
      const DeepCollectionEquality().hash(dropdownTheme),
    );
  }
}
