...
class YgBottomNavigationBarTheme
    extends ThemeExtension<YgBottomNavigationBarTheme> {
  ...
  static final YgBottomNavigationBarTheme
  consumerLight = YgBottomNavigationBarTheme(
    ...
    pressedBackgroundColor:
        _$YgBottomNavigationBarTheme.pressedBackgroundColor[0],
    selectedIconColor: _$YgBottomNavigationBarTheme.selectedIconColor[0],
    selectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedSubtitleTextStyle[0],
    selectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedTitleTextStyle[0],
    ...
    unselectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedSubtitleTextStyle[0],
    unselectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedTitleTextStyle[0],
  );

  static final YgBottomNavigationBarTheme
  consumerDark = YgBottomNavigationBarTheme(
    ...
    pressedBackgroundColor:
        _$YgBottomNavigationBarTheme.pressedBackgroundColor[1],
    selectedIconColor: _$YgBottomNavigationBarTheme.selectedIconColor[1],
    selectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedSubtitleTextStyle[1],
    selectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedTitleTextStyle[1],
    ...
    unselectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedSubtitleTextStyle[1],
    unselectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedTitleTextStyle[1],
  );

  static final YgBottomNavigationBarTheme
  professionalLight = YgBottomNavigationBarTheme(
    ...
    pressedBackgroundColor:
        _$YgBottomNavigationBarTheme.pressedBackgroundColor[2],
    selectedIconColor: _$YgBottomNavigationBarTheme.selectedIconColor[2],
    selectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedSubtitleTextStyle[2],
    selectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedTitleTextStyle[2],
    ...
    unselectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedSubtitleTextStyle[2],
    unselectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedTitleTextStyle[2],
  );

  static final YgBottomNavigationBarTheme
  professionalDark = YgBottomNavigationBarTheme(
    ...
    pressedBackgroundColor:
        _$YgBottomNavigationBarTheme.pressedBackgroundColor[3],
    selectedIconColor: _$YgBottomNavigationBarTheme.selectedIconColor[3],
    selectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedSubtitleTextStyle[3],
    selectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.selectedTitleTextStyle[3],
    ...
    unselectedSubtitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedSubtitleTextStyle[3],
    unselectedTitleTextStyle:
        _$YgBottomNavigationBarTheme.unselectedTitleTextStyle[3],
  );
  ...
  YgBottomNavigationBarTheme copyWith({
    ...
    return YgBottomNavigationBarTheme(
      ...
      selectedSubtitleTextStyle:
          selectedSubtitleTextStyle ?? this.selectedSubtitleTextStyle,
      selectedTitleTextStyle:
          selectedTitleTextStyle ?? this.selectedTitleTextStyle,
      titleSubtitleSpacing: titleSubtitleSpacing ?? this.titleSubtitleSpacing,
      unselectedIconColor: unselectedIconColor ?? this.unselectedIconColor,
      unselectedSubtitleTextStyle:
          unselectedSubtitleTextStyle ?? this.unselectedSubtitleTextStyle,
      unselectedTitleTextStyle:
          unselectedTitleTextStyle ?? this.unselectedTitleTextStyle,
    );
  }

  @override
  YgBottomNavigationBarTheme lerp(
    covariant ThemeExtension<YgBottomNavigationBarTheme>? other,
    double t,
  ) {
    if (other is! YgBottomNavigationBarTheme)
      return this as YgBottomNavigationBarTheme;
    return YgBottomNavigationBarTheme(
      ...
      selectedSubtitleTextStyle: TextStyle.lerp(
        selectedSubtitleTextStyle,
        other.selectedSubtitleTextStyle,
        t,
      )!,
      selectedTitleTextStyle: TextStyle.lerp(
        selectedTitleTextStyle,
        other.selectedTitleTextStyle,
        t,
      )!,
      ...
      unselectedSubtitleTextStyle: TextStyle.lerp(
        unselectedSubtitleTextStyle,
        other.unselectedSubtitleTextStyle,
        t,
      )!,
      unselectedTitleTextStyle: TextStyle.lerp(
        unselectedTitleTextStyle,
        other.unselectedTitleTextStyle,
        t,
      )!,
    );
  }
