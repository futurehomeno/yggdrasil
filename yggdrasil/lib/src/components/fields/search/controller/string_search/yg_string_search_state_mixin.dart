...
mixin YgStringSearchStateMixin<Widget extends StatefulWidget> on State<Widget>
    implements YgSearchStateMixinInterface<String, String, YgStringSearchResult, YgStringSearchResultsLayout> {
  @override
