  ...
  YgTagTheme lerp(covariant ThemeExtension<YgTagTheme>? other, double t) {
    ...
    return YgTagTheme(
      ...
      iconStrongDisabledColor: Color.lerp(
        iconStrongDisabledColor,
        other.iconStrongDisabledColor,
        t,
      )!,
      iconWeakColor: Color.lerp(iconWeakColor, other.iconWeakColor, t)!,
      iconWeakDisabledColor: Color.lerp(
        iconWeakDisabledColor,
        other.iconWeakDisabledColor,
        t,
      )!,
      informativeTagTheme: informativeTagTheme.lerp(
        other.informativeTagTheme,
        t,
      ) as YgInformativeTagTheme,
      negativeTagTheme: negativeTagTheme.lerp(
        other.negativeTagTheme,
        t,
      ...
      positiveTagTheme: positiveTagTheme.lerp(
        other.positiveTagTheme,
        t,
      ) as YgPositiveTagTheme,
      splashStrongColor: Color.lerp(
        splashStrongColor,
        other.splashStrongColor,
        t,
      )!,
