...
class StandardIconButtonTheme extends ThemeExtension<StandardIconButtonTheme> {
  ...
  static final StandardIconButtonTheme consumerLight = StandardIconButtonTheme(
    ...
    disabledBackgroundColor: _$StandardIconButtonTheme.disabledBackgroundColor[0],
  ...
  static final StandardIconButtonTheme consumerDark = StandardIconButtonTheme(
    ...
    disabledBackgroundColor: _$StandardIconButtonTheme.disabledBackgroundColor[1],
    disabledIconColor: _$StandardIconButtonTheme.disabledIconColor[1],
    iconColor: _$StandardIconButtonTheme.iconColor[1],
  );

  static final StandardIconButtonTheme professionalLight = StandardIconButtonTheme(
    backgroundColor: _$StandardIconButtonTheme.backgroundColor[2],
    disabledBackgroundColor: _$StandardIconButtonTheme.disabledBackgroundColor[2],
    disabledIconColor: _$StandardIconButtonTheme.disabledIconColor[2],
    iconColor: _$StandardIconButtonTheme.iconColor[2],
  );

  static final StandardIconButtonTheme professionalDark = StandardIconButtonTheme(
    backgroundColor: _$StandardIconButtonTheme.backgroundColor[3],
    disabledBackgroundColor: _$StandardIconButtonTheme.disabledBackgroundColor[3],
  ...
  @override
  StandardIconButtonTheme lerp(covariant ThemeExtension<StandardIconButtonTheme>? other, double t) {
    if (other is! StandardIconButtonTheme) return this as StandardIconButtonTheme;
    return StandardIconButtonTheme(
