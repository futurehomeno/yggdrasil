              ...
              content: YgLayoutBody.sliver(
                sliver: SliverList.list(
                  children: <Widget>[
                    ...
                    YgListTile(
                      title: 'Statistics - ChartContainer',
                      onTap: () => sl<YgRouter>().push(ChartContainerScreen.route()),
                      trailingWidgets: const <YgIcon>[YgIcon(YgIcons.caretRight)],
                    ),
                    YgListTile(
                      title: 'Statistics - ChartSimple',
                      onTap: () => sl<YgRouter>().push(ChartSimpleScreen.route()),
                      trailingWidgets: const <YgIcon>[YgIcon(YgIcons.caretRight)],
                    ),
                    YgListTile(
                    ...
                    YgListTile(
                      title: 'TileSelector',
                      onTap: () => sl<YgRouter>().push(TileSelectorScreen.route()),
                      trailingWidgets: const <YgIcon>[YgIcon(YgIcons.caretRight)],
                    ),
                    YgListTile(
                      title: 'ToggleButton',
