...
class YgAvatarTheme extends ThemeExtension<YgAvatarTheme> {
  ...
  YgAvatarTheme lerp(covariant ThemeExtension<YgAvatarTheme>? other, double t) {
    ...
    return YgAvatarTheme(
      ...
      avatarStackTheme: avatarStackTheme.lerp(
        other.avatarStackTheme,
        t,
      ) as YgAvatarStackTheme,
      backgroundColor: Color.lerp(backgroundColor, other.backgroundColor, t)!,
      borderSide: t < 0.5 ? borderSide : other.borderSide,
      companyAvatarTheme: companyAvatarTheme.lerp(
        other.companyAvatarTheme,
        t,
      ...
      imageBackgroundColor: Color.lerp(
        imageBackgroundColor,
        other.imageBackgroundColor,
        t,
      )!,
      initialsLargeTextStyle: TextStyle.lerp(
        initialsLargeTextStyle,
        other.initialsLargeTextStyle,
        t,
      )!,
      ...
      personAvatarTheme: personAvatarTheme.lerp(
        other.personAvatarTheme,
        t,
