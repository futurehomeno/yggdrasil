...
class YgTextLinkTheme extends ThemeExtension<YgTextLinkTheme> {
  ...
  YgTextLinkTheme lerp(
    covariant ThemeExtension<YgTextLinkTheme>? other,
    double t,
  ) {
    ...
    return YgTextLinkTheme(
      ...
      mediumStrongTextStyle: TextStyle.lerp(
        mediumStrongTextStyle,
        other.mediumStrongTextStyle,
        t,
      )!,
      mediumWeakTextStyle: TextStyle.lerp(
        mediumWeakTextStyle,
        other.mediumWeakTextStyle,
        t,
      )!,
      padding: t < 0.5 ? padding : other.padding,
      pressedColor: Color.lerp(pressedColor, other.pressedColor, t)!,
      smallStrongTextStyle: TextStyle.lerp(
        smallStrongTextStyle,
        other.smallStrongTextStyle,
        t,
      )!,
      smallWeakTextStyle: TextStyle.lerp(
        smallWeakTextStyle,
        other.smallWeakTextStyle,
        t,
      )!,
    );
  }
