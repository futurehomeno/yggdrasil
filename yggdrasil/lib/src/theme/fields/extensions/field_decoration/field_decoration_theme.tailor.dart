...
part of 'field_decoration_theme.dart';

// **************************************************************************
// TailorAnnotationsGenerator
// **************************************************************************

class YgFieldDecorationTheme extends ThemeExtension<YgFieldDecorationTheme> {
  const YgFieldDecorationTheme({
    ...
    required this.largeStandardContentPadding,
    required this.mediumOutlinedContentPadding,
    required this.mediumStandardContentPadding,
  ...
  final EdgeInsets largeStandardContentPadding;
  final EdgeInsets mediumOutlinedContentPadding;
  final EdgeInsets mediumStandardContentPadding;
  ...
  static final YgFieldDecorationTheme
  professionalLight = YgFieldDecorationTheme(
  ...
  @override
  YgFieldDecorationTheme copyWith({
    ...
    EdgeInsets? largeStandardContentPadding,
    EdgeInsets? mediumOutlinedContentPadding,
    EdgeInsets? mediumStandardContentPadding,
  ...
  YgFieldDecorationTheme lerp(
    covariant ThemeExtension<YgFieldDecorationTheme>? other,
    double t,
  ) {
    ...
    return YgFieldDecorationTheme(
      ...
      backgroundErrorColor: Color.lerp(
        backgroundErrorColor,
        other.backgroundErrorColor,
        t,
      )!,
      ...
      borderRadiusOutlined: t < 0.5
          ? borderRadiusOutlined
          : other.borderRadiusOutlined,
      ...
      outlinedSuffixPadding: t < 0.5
          ? outlinedSuffixPadding
          : other.outlinedSuffixPadding,
      standardSuffixPadding: t < 0.5
          ? standardSuffixPadding
          : other.standardSuffixPadding,
    );
  }
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      const DeepCollectionEquality().hash(largeStandardContentPadding),
      const DeepCollectionEquality().hash(mediumOutlinedContentPadding),
