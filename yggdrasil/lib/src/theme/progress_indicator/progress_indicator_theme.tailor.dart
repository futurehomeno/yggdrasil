...
class YgProgressIndicatorTheme
  ...
  static final YgProgressIndicatorTheme consumerLight =
      YgProgressIndicatorTheme(
        ...
        progressPercentageIndicatorTheme:
            _$YgProgressIndicatorTheme.progressPercentageIndicatorTheme[0],
      );
  ...
  static final YgProgressIndicatorTheme consumerDark = YgProgressIndicatorTheme(
    ...
    progressPercentageIndicatorTheme:
        _$YgProgressIndicatorTheme.progressPercentageIndicatorTheme[1],
  );
  ...
  static final YgProgressIndicatorTheme professionalLight =
      YgProgressIndicatorTheme(
        ...
        progressPercentageIndicatorTheme:
            _$YgProgressIndicatorTheme.progressPercentageIndicatorTheme[2],
      );
  ...
  static final YgProgressIndicatorTheme professionalDark =
      YgProgressIndicatorTheme(
        ...
        progressPercentageIndicatorTheme:
            _$YgProgressIndicatorTheme.progressPercentageIndicatorTheme[3],
      );
  ...
  YgProgressIndicatorTheme copyWith({
    ...
    return YgProgressIndicatorTheme(
      ...
      progressPercentageIndicatorTheme:
          progressPercentageIndicatorTheme ??
          this.progressPercentageIndicatorTheme,
    );
  }

  @override
  YgProgressIndicatorTheme lerp(
    covariant ThemeExtension<YgProgressIndicatorTheme>? other,
    double t,
  ) {
    ...
    return YgProgressIndicatorTheme(
      ...
      progressPercentageIndicatorTheme: progressPercentageIndicatorTheme.lerp(
        other.progressPercentageIndicatorTheme,
        t,
